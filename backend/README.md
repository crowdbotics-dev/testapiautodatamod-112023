...
## Project Structure
    ...
    ├── testapiautodatamod_112023  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_112023`
...
2. Clone this repo and `cd testapiautodatamod_112023`
